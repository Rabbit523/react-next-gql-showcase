...
const ItemsCreated: FC<ItemsCreatedProps> = ({
  targetAccount,
  ...
  //     },
  //   })
  const { data, error, mutate, size, setSize, isValidating } = useItemsByCreator({
    variables: {
      creator: makeUnionAddress(ChainId.MAINNET, targetAccount),
      size: limit,
    },
    swrConfig: {
