...
import { updateMatchesDarkMode, updateUserDarkMode } from './nftmall/actions'
import { DarkmodeState, DarkmodeInitialState } from './nftmall/reducer'

const currentTimestamp = () => new Date().getTime()

export interface UserState extends DarkmodeState {
