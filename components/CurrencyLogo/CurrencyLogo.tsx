...
// @nftgeek
const BttcLogo = 'https://res.cloudinary.com/nftmall/image/upload/v1650658282/theme/networks/bttc.jpg'
const ThunderCoreLogo = 'https://res.cloudinary.com/nftmall/image/upload/v1650658282/theme/networks/thundercore.jpg'
...
const LOGO: Record<ChainId, string> = {
  ...
  [ChainId.THUNDERCORE_TESTNET]: ThunderCoreLogo,
  [ChainId.BTTC]: BttcLogo,
  [ChainId.BTTC_TESTNET]: BttcLogo,
}
